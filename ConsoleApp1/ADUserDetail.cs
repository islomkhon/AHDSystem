    ...
    public class ADUserDetail
    {
        ...
        private ADUserDetail(DirectoryEntry directoryUser)
        {
            ...
            if (!string.IsNullOrEmpty(userPrincipalName))
            {
                ...
                {
                    domainAddress = userPrincipalName;
                }
            }
            else
            {
            ...
            //Console.WriteLine(GetProperty(directoryUser, ADProperties.MANAGER));
        ...
        public UserDetail copyToUserDetails()
        {
            UserDetail userDetail = new UserDetail();
            userDetail.FirstName = this.FirstName;
            userDetail.MiddleName = this.MiddleName;
            userDetail.LastName = this.LastName;
            userDetail.LoginName = this.LoginName;
            userDetail.LoginNameWithDomain = this.LoginNameWithDomain;
            userDetail.StreetAddress = this.StreetAddress;
            userDetail.City = this.City;
            userDetail.State = this.State;
            userDetail.PostalCode = this.PostalCode;
            userDetail.Country = this.Country;
            userDetail.HomePhone = this.HomePhone;
            userDetail.Extension = this.Extension;
            userDetail.Mobile = this.Mobile;
            userDetail.Fax = this.Fax;
            userDetail.EmailAddress = this.EmailAddress.ToLower();
            userDetail.Title = this.Title;
            userDetail.Company = this.Company;
            userDetail.Manager = this.ManagerName;
            userDetail.Department = this.Department;
            return userDetail;
    }
    }
}
