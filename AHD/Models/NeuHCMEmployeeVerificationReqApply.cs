...
{
    [BsonDiscriminator("NeuHCMEmployeeVerificationReqApply")]
    public class NeuHCMEmployeeVerificationReqApply
    {
        /*[BsonId]
        ...
        [BsonElement("NeuHCMEmployeeVerificationReqUiRender")]
        public NeuHCMEmployeeVerificationReqUiRender leaveCancelationUiRender { get; set; }

    }

    public class NeuHCMEmployeeVerificationReqUiRender
    {
        [BsonElement("LeaveStartDate")]
        public string leaveStartDate { get; set; }
        [BsonElement("LeaveEndDate")]
