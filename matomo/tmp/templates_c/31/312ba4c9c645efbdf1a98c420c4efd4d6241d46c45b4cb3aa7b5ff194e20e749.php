...
class __TwigTemplate_a5b66ce86abef2733d1e8624a58c12ea0c1899fee2a2862b159f912070e64b5c extends Twig_Template
{
...
($context["reports"] ?? $this->getContext($context, "reports")))) {
    ...
    ";
            ...
            <td class=\"first\">
                ";
                // line 43
                echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array($this->getAttribute($context["report"], "description", array())));
                echo "
                ";
                // line 44
...
$context["report"], "format", array()), array(0 => "html", 1 => "csv"))) ? ($this->getAttribute($context["report"], "format", array())) : (false))))), "html", null, true);
                // line 82
                echo "\"
                   rel=\"noreferrer noopener\" target=\"_blank\" name=\"linkDownloadReport\" id=\"";
                // line 83
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($context["report"], "idreport", array()), "html", null, true);
...
", "@ScheduledReports/_listReports.twig", "D:\\xampp\\htdocs\\matomo\\plugins\\ScheduledReports\\templates\\_listReports.twig");
    }
}
