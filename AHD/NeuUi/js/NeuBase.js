            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        url: "/HcmAHDDashboard/SubApproveLeaveCancelationRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/SubApproveLeavePastApplyRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/WithdrawLeaveCancelationRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/WithdrawLeavePastApplyRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/WithdrawLeaveWFHApplyRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/WithdrawLeaveBalanceEnqRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/WithdrawHCMAddressProofReqRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/WithdrawHCMEmployeeVerificationRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/CloseLeaveCancelationRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/CloseLeavePastApplyRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/CloseWFHLeaveApplyRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/CloseBalanceEnqLeaveRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/CloseHCMAddressProofRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/CloseHCMEmployeeVerificationRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/ApproveLeaveCancelationRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/ApproveLeavePastApplyRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/ApproveWFHLeaveRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/ApproveBalanceEnqLeaveRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/ApproveHCMAddressProofRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
            ...
            swal({
                ...
                if (value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        enctype: 'multipart/form-data',
                        url: "/HcmAHDDashboard/ApproveHCMEmployeeVerificationRequest",
                        data: formData,
                        processData: false,
                        contentType: false,
                        cache: false,
